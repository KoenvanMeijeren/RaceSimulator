...
namespace Controller
{
    public static class Data
    {
        ...
        private static void AddTestParticipants()
        {
            ...
            Data.AddParticipant(new Driver(name: "Henk", points: 190, equipment: new Car(quality: 65, performance: 1, speed: 50), teamColor: TeamColors.Blue));
            // Data.AddParticipant(new Driver(name: "Jan", points: 195, equipment: new Car(quality: 65, performance: 2, speed: 50), teamColor: TeamColors.Green));
